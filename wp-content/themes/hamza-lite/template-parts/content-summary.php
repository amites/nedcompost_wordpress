...
<?php 
$image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'hamza-lite-portfolio-image', false ); 
?>
...
<article id="post-<?php the_ID(); ?>" class="cat-portfolio-list">
<?php 
$image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'hamza-lite-blog-image', false ); 
?>
	<header class="entry-header">
